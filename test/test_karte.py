...
class KarteTest(unittest.TestCase):
    ...
    def testiraj_karte_fajl(self):
        ...
        self.maxDiff = None
        self.assertIsNotNone(ucitane_karte, msg="Nisu ucitane karte iz fajla")
        self.assertEqual(len(referentne_karte), len(ucitane_karte), msg="Duzine ucitanih karata nisu jednake")
        for k in ucitane_karte:
            ucitana_karta = ucitane_karte[k]
            self.assertDictEqual(referentne_karte[k], ucitana_karta, msg="Ucitane karte se ne poklapaju")
