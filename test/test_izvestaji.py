...
class IzvestajiTest(unittest.TestCase):
    ...
    def test_uspesan_izvestaj_prodatih_karata_za_dan_prodaje(self):
        ...
        self.assertIsNotNone(nadjene_karte, msg="Nije vracena kolekcija karata")
    ...
    def test_izvestaj_prodatih_karata_za_dan_prodaje_i_prodavca(self):
        ...
        self.assertIsNotNone(sve_karte, msg="Nije vracena kolekcija karata")
    ...
    def test_izvestaj_ubc_prodatih_karata_za_dan_prodaje(self):
        ...
        self.assertIsNotNone(broj, msg="Nije vracen broj karata")
        self.assertIsNotNone(suma, msg="Nije vracena suma cena")
    ...
    def test_izvestaj_ubc_prodatih_karata_za_dan_prodaje_nepostojeci_dan(self):
        ...
        self.assertIsNotNone(rezultat, msg="Nije vracena kolekcija ")
