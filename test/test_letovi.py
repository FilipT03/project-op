...
from test.test_utils import rand_str, rand_valid_user, rand_time_str, rand_seat_positions, rand_datetime, rand_valid_aerodrom
...
class LetoviTest(unittest.TestCase):
    def setUp(self):
        ...
        svi_aerodromi = {}
        for i in range(10):
            aerodrom = rand_valid_aerodrom()
            svi_aerodromi[aerodrom["skracenica"]] = aerodrom
        aerodromi.sacuvaj_aerodrome("aerodromi.csv", "|", svi_aerodromi)
        ...
        model_aviona.sacuvaj_modele_aviona("modeli_aviona.csv", "|", self.modeli_aviona)
        ...
        for i in range(20):
            ...
            self.pun_let = {
                "broj_leta": broj_leta,
                "sifra_polazisnog_aerodroma": random.choice(list(svi_aerodromi.keys())),
                "sifra_odredisnog_aerodorma": random.choice(list(svi_aerodromi.keys())),
                "vreme_poletanja": rand_time_str(),
                "vreme_sletanja": rand_time_str(),
                "datum_pocetka_operativnosti": pocetak_operativnosti,
                "datum_kraja_operativnosti": kraj_operativnosti,
                ...
                "prevoznik": rand_str(10),
                "dani": dani,
                "model": self.modeli_aviona[random.choice([100,101,102])],
                "cena": 100 + random.random() * 200
            }
            self.pun_korisnik = rand_valid_user()
            self.svi_letovi = {
...
'''
    ...
    def test_kreiraj_let_validan(self):
        ...
        self.assertIsNotNone(svi_letovi, msg="Nije vracena kolekcija letova")
    ...
    def test_pretraga_letova_uspesno_po_polazistu(self):
        ...
        self.assertIsNotNone(trazeni_letovi, msg="Nije vracena kolekcija letova")
        self.assertEqual(1, len(trazeni_letovi), msg="Nije vracen ocekivan broj u rezultatu")
    ...
    def testiraj_letovi_fajl(self):
        ...
        self.assertIsNotNone(ucitani_letovi, msg="Nisu ucitani letovi iz fajla")
        self.assertEqual(len(referentni_letovi), len(ucitani_letovi), msg="Duzine ucitanih letova nisu jednake")
        for k in ucitani_letovi:
            ...
            self.assertEqual(referentni_letovi[k]["broj_leta"],
                             ucitani_let["broj_leta"], msg="Ucitani letovi se ne poklapaju broj leta")
            self.assertEqual(referentni_letovi[k]["sifra_polazisnog_aerodroma"], ucitani_let["sifra_polazisnog_aerodroma"],msg="Ucitani letovi se ne poklapaju polaziste")
            self.assertEqual(referentni_letovi[k]["sifra_odredisnog_aerodorma"],
                             ucitani_let["sifra_odredisnog_aerodorma"], msg="Ucitani letovi se ne poklapaju odrediste")
            self.assertEqual(referentni_letovi[k]["vreme_poletanja"],
                             ucitani_let["vreme_poletanja"], msg="Ucitani letovi se ne poklapaju vreme_poletanja")
            self.assertEqual(referentni_letovi[k]["vreme_sletanja"],
                             ucitani_let["vreme_sletanja"], msg="Ucitani letovi se ne poklapaju vreme_sletanja")
            self.assertEqual(referentni_letovi[k]["sletanje_sutra"],
                             ucitani_let["sletanje_sutra"], msg="Ucitani letovi se ne poklapaju sletanje sletanje_sutra")
            self.assertEqual(referentni_letovi[k]["prevoznik"],
                             ucitani_let["prevoznik"],
                             msg="Ucitani letovi se ne poklapaju sletanje prevoznik")
            self.assertEqual(referentni_letovi[k]["cena"],
                             ucitani_let["cena"],
                             msg="Ucitani letovi se ne poklapaju sletanje cena")

            #self.assertDictEqual(referentni_letovi[k], ucitani_let, msg="Ucitani letovi se ne poklapaju")
